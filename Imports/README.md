...
You have now the possibility to **import** your **personnal `*.json` files** list (for S24+ or other devices) with v2 version of [Manual Execution](https://github.com/Ruvyrom/Ruvomain-Protocole/tree/main#2manual-execution-linuxtermuxmacos) script for Linux/Termux/macOS and /Imports folder:
